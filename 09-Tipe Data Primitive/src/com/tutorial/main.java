...
public class main {
    ...
    public static void main(String[] args){
        ...
        System.out.println("Besar integer = " + " bytes");
        ...
        System.out.println("Besar byte = " + " bytes");
        ...
        System.out.println("Besar short = " +  " bytes");
        ...
        System.out.println("Besar long = " + " bytes");
        ...
        System.out.println("Besar double = " + " bytes");
        ...
        System.out.println("Besar float = " + " bytes");
        ...
        System.out.println("Besar char = " +  " bytes");
